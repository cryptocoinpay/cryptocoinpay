...
import (
	...
	"github.com/bob/go-bob/console/jsre"
	"github.com/bob/go-bob/console/web3ext"
...
func (c *Console) init(preload []string) error {
	...
	if err := c.jsre.Compile("web3-bob.js", jsre.Web3_JS); err != nil {
		return fmt.Errorf("web3-bob.js: %v", err)
	}
	if _, err := c.jsre.Run("var Web3 = require('web3-bob');"); err != nil {
		return fmt.Errorf("web3-bob require: %v", err)
	}
	...
	flatten := "var bob = web3.bob; var personal = web3.personal; "
	for api := range apis {
		if api == "web3" {
...
func (c *Console) Welcome() {
	...
	c.jsre.Run(`
		...
		console.log("coinbase: " + bob.coinbase);
		console.log("at block: " + bob.blockNumber + " (" + new Date(1000 * bob.getBlock(bob.blockNumber).timestamp) + ")");
